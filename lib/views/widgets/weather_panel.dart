        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.access_time, color: theme.alert, size: 12),
              ...
              // Weather Details - Made more compact
              Wrap(
                spacing: 8.0,
                runSpacing: 8.0,
                children: [
              ...
              // Weather Advice - Made more compact
              Container(
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Icon(forecast.icon, color: theme.primary, size: 28),
                          const SizedBox(height: 4),
                          Text(
                            '${forecast.temp}°',
                            style: AppTheme.getHudTextStyle(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: AppTheme.getHudTextStyle(
                                  color: theme.alert.withValues(alpha:0.8),
                                  fontSize: 9,
                                ),
                              ),
                            ],
